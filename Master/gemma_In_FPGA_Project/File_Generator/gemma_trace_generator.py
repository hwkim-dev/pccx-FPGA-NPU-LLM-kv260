...
def generate_hi_token_trace():
    ...
    # Assuming that it has been converted into square mean and attention score through MAC Array!

    mean_sq_val = 16777216  # Square mean to enter RMSNorm (e.g. 2^24)
    ...
    # =====================================================================
    # 3. Hardware scaling (convert to Q1.15 format)
    # =====================================================================
    SCALE_Q15 = 32768.0
    ...
    # =====================================================================
    # 4. Output results (copy paste to Testbench)
    # =====================================================================
    print("==================================================")
    print("[Input data (value to be injected into Testbench with a syringe)]")
    ...
    print(f"- o_rmsnorm_val : {rmsnorm_hw_expected} (actual mathematical value: {rmsnorm_true:.6f})")
    print(f"- o_softmax_prob: {softmax_hw_expected} (actual mathematical value: {softmax_true:.6f})")
    print("==================================================")
    print("\n [NEXT STEP] Let’s take this answer sheet and go verify gemma_layer_top!")
