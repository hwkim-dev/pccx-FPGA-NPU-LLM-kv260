...
def main():
    ...
    TOP_P          = 0.9
    REP_PENALTY    = 1.05  # Lower from 1.15 to around 1.05 (almost no intervention)
    MAX_NEW_TOKENS = 512
    ...
    # E2B characteristics: KV cache initialization with 30 layers
