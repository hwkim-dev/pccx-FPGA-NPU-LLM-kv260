...
def load_local_weights(model_dir=default_model_dir):
    ...
    for filename in st_files:
        ...
        for k, v in pt_tensors.items():
            ...
            # 2. Transpose Check the necessary tensors in advance and fix them in continuous memory
            ...
            # 3. Direct assignment of layer parameters (without creating intermediate copies)
        ...
        # Core: Read file by file and free memory immediately
        del pt_tensors
        gc.collect()
    ...
    # Release any remaining temporary dictionaries
    del globals_dict
    gc.collect()
